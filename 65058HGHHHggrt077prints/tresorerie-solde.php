              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px">Transactions_<?= $tresor ?> du <?= $date ?></h5>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="border: 1px solid #000;font-weight: bold;">Ref </th>
                            <th style="border: 1px solid #000;font-weight: bold;">COMPTE #1</th>
                            <th style="border: 1px solid #000;font-weight: bold;">COMPTE #2</th>
