              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px">Transactions du compte <?= $tresor ?> du <?= $date_debut ?> au <?= $date_fin ?></h5>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="width: 100px;border: 1px solid #000;font-weight: bold;">DATE </th>
                            <th style="width: 120px;border: 1px solid #000;font-weight: bold;">COMPTE_1 </th>
                            <th style="border: 1px solid #000;font-weight: bold;">COMPTE_2 </th>
                            <th style="border: 1px solid #000;font-weight: bold;">LIBELLE </th>
                            <th style="border: 1px solid #000;font-weight: bold;">TAUX </th>
                            <th style="border: 1px solid #000;font-weight: bold;">ENTREES<span>_USD</span></th>
                            <th style="border: 1px solid #000;font-weight: bold;">SORTIES<span>_USD</span></th>
                            <th style="border: 1px solid #000;font-weight: bold;">ENTREES<span>_CDF</span></th>
                            <th style="border: 1px solid #000;font-weight: bold;">SORTIES<span>_CDF</span></th>
                          </tr>
                        </thead>
                        <tbody>
                          <?= listing_tresorerieperiod() ?>
                        </tbody>
                      </table>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row w-100" style="padding: 11px">
                      ...
                      <fieldset class="col-lg-3 col-md-3 col-sm-12">
                        <p class="lien"><a href="dashboard.php" class="btn btn-primary" style="background-color: #44597b">Revenir à la page précédente</a></p>
                      </fieldset>
                      <fieldset class="col-lg-3 col-md-3 col-sm-12">
