...
<html lang="fr">
  <head>
    ...
    <style>
      ...
      .main {width: 90%;margin-left: 5%;margin-top: 3%}
    </style>
  </head>
  <body>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px"><b>TRESORERIE NETTE </b></h5>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          ...
                          <th style="border: 1px solid #000;font-weight: bold;">Id</th>
                            ...
                            <th style="border: 1px solid #000;font-weight: bold;">Totaux_debit_USD</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Totaux_credit_USD</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Solde_USD</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php Etat_rapport_global_compta_autre2(); ?>
                        </tbody>
                      </table>
                    </div>
                  </div>
