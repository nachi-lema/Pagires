<?php
  ...
  $trans_debut = $_SESSION['debut'];
  $trans_fin = $_SESSION['fin'];
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px">Transactions du <?= $trans_debut ?> au <?= $trans_fin ?></h5>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="border: 1px solid #000;font-weight: bold;">Date D'op</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Ref_doc</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Client &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th style="border: 1px solid #000;font-weight: bold;">N°Compte</th>
