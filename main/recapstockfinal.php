              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="">Recapitulatif_stock-final</h4>
                    <a href="recapstockfinal.php" class="btn btn-info"><i class="fa fa-spinner"></i> Actualiser </a>
                  </div>
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="p-3">
                        <form method="GET" action="recapstockfinal.php" class="form_filter col-lg-3 col-md-3 col-sm-12">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        ...
                        <tbody><?php recapstockfinal(); ?></tbody>
                      </table>
                    </div>
                  </div>
                </div>
