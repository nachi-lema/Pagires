              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header dropdown">
                    ...
                    <a href="facture_autre.php" class="btn btn-info"><i class="fa fa-spinner"></i> Actualiser</a>
                  </div>
                  <div class="row">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header" style="border:1px solid #ccc">
                              <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-shopping-bag"></i>&nbsp;FACTURE AUTRES</h5>
                            </div>
