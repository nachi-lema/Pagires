        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header dropdown">
              <h4 class="">MAJ_Encodage_Transactions -TIERS</h4>
              <li><a href="maj-encodage_tiers.php" class="btn btn-primary" style="background-color: #44597b"><i class="fa fa-spinner"></i> Actualiser</a></li>
              <li>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="p-3">
                  <form method="GET" action="maj-encodage_tiers.php" class="form_filter col-lg-3 col-md-3 col-sm-12">
