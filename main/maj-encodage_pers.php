          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header dropdown">
                <h4 class="">MAJ_Encodage_Transactions -PERSONNEL</h4>
                <li><a href="maj-encodage_pers.php" class="btn btn-primary" style="background-color: #44597b"><i class="fa fa-spinner"></i> Actualiser<i></i></a></li>
                <li>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="p-3">
                    <form method="GET" action="maj-encodage_pers.php" class="form_filter col-lg-3 col-md-3 col-sm-12">
                    ...
                    <form method="GET" action="maj-encodage_pers.php" class="form_filter col-lg-3 col-md-3 col-sm-12">
                      <div class="input-group">
                        <input type="search" name="nom_pers" placeholder="Filtrer par nom" autocomplete="on" required class="form-control" tabindex="10" style="color: #575757;" onfocus="this.value=''" />
                        <div class="input-group-btn m-0 p-0">
                          <button type="submit" class="btn btn-warning m-0" tabindex="50"><i class="fa fa-check"></i></button>
                        </div>
                      </div>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped table-hover" id='table-r'>
                    ...
                    <tbody><?php liste_paeifrais_pers(); ?></tbody>
                  </table>
                </div>
              </div>
            </div>
