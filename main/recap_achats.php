              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="">Recapitulatif_achats</h4>
                    <a href="recap_achats.php" class="btn btn-info"><i class="fa fa-spinner"></i> Actualiser </a>
                  </div>
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="p-3">
                        <form method="GET" action="recap_achats.php" class="form_filter col-lg-3 col-md-3 col-sm-12">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        ...
                        <tbody><?php impress_achats(); ?></tbody>
                      </table>
                    </div>
                  </div>
                </div>
