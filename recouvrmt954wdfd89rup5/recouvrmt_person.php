              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px">
                      <b>RECAPITULATIF-RECOUVREMENT PERSONNEL-USD</b><br>
                      <span> </span>
                    </h5>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          <tr>
                            <th style="border: 1px solid #000;font-weight: bold;">Noms &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th style="border: 1px solid #000;font-weight: bold;">No_compte </th>
                            <th style="border: 1px solid #000;font-weight: bold;">Fonction</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Report_USD</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Debit_USD</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Credits_USD</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Solde_USD</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php Etat_recvremntpersousd(); ?>
                        </tbody>
                      </table>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row w-100" style="padding: 21px">
                      ...
                      <fieldset class="col-lg-3 col-md-3 col-sm-12">
                        <p><a href="../main/dashboard.php" class="btn btn-primary" style="background-color: #44597b">Revenir à la page précédente</a></p>
                      </fieldset>
                      <fieldset class="col-lg-3 col-md-3 col-sm-12">
                        <button id="print" class="btn btn-primary mt-2" tabindex="170" style="background-color: #304c79">
                          <i class="fa fa-print"></i> Imprimer
                        </button>
                      </fieldset>
                      <fieldset class="col-lg-3 col-md-3 col-sm-12">
                        <button type="button" id="export_button" class="btn btn-success" style="font-weight: bold;font-size: 14px">Excel</button>
                      </fieldset>
                    </div>
                  </div>
                </div>
