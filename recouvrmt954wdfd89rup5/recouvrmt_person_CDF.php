                ...
                <div class="card">
                  <div class="card-header">
                    <h5 style="text-align: center;width: 90%;font-size: 24px">
                      <b>RECAPITULATIF-RECOUVREMENT PERSONNEL-CDF</b><br>
                      <span> </span>
                    </h5>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id='table-r' style="width:100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="border: 1px solid #000;font-weight: bold;">Report_CDF</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Debit_CDF</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Credits_CDF</th>
                            <th style="border: 1px solid #000;font-weight: bold;">Solde_CDF</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php Etat_recvremntpersoCDF(); ?>
                        </tbody>
                      </table>
                    </div>
                  </div>
