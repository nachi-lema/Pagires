    ...
    <footer class="main-footer">
      <div class="footer-left">
        <span style="font-size: 12px;">Copyright © 2024 - Tous droits réservés </span><a href="#" class="" style="font-size: 14px;color: #304c79;font-weight: bold;"> DRC-Payroll</a>
      </div>
    </footer>
    ...
    <link rel="stylesheet" href="https://www.bellevue-sp.org/assets/bundles/datatables/datatables.min.css">
